...
# define DANZEFF_LEFT         187
# define DANZEFF_DOWN         188
# define DANZEFF_UP           189
# define DANZEFF_RIGHT        190
...
extern unsigned int danzeff_readMouse(gp2xCtrlData* pspctrl);
extern unsigned int danzeff_isMouseInside(gp2xCtrlData* pspctrl);
